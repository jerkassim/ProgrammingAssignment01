...
public class Main {
    public static void main(String[] args) {
        ...
        int targetId = 108;
        Ticket found = board.findByIdBinarySearch(targetId);
        System.out.println("\nSearch result for ID " + targetId + ": " +
        ...
        System.out.println("Complexity 2 + after-hours 3: " +
                t.estimateResolutionHours(2, 3));
    }
}
